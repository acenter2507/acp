(function () {
  ...
  describe('Colors Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      it('should send a POST request with the form input values and then locate to new object URL', inject(function (ColorsService) {
        ...
        expect($state.go).toHaveBeenCalledWith('colors.view', {
          colorId: mockColor._id
        });
      }));
    ...
    describe('vm.save() as update', function () {
      ...
      it('should set $scope.vm.error if error', inject(function (ColorsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Color and redirect to Colors', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('colors.list');
      });
